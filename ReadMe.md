...
│       ├── view_Top3.csv
│       ├── sample_metadata.csv
│       └── opdea_candidate_results/
│           ├── workflow1_results.csv
│           ├── workflow2_results.csv
│           └── workflow3_results.csv
├── R/
│   ├── 01_tutorial1_workflow_optimization.R
│   ├── 02_tutorial2_multiview_learning.R
│   ├── 03_tutorial3_biomarker_discovery.R
│   └── utils.R
├── results/
│   └── .gitkeep
└── figures/
...
Repository maintainer: YOUR_NAME
Email: YOUR_EMAIL
